...
/**
 * This models supports retrieving lists of albums.
 *
 * @package     Albums
 * @subpackage  com_albums
 * @since       3.1
 */
class AlbumsModelAlbums extends JModelList
{
	/**
	 * Category items data
	 *
	...
	protected function getListQuery()
	{
		...
		$query->select(
			$this->getState(
				...
				. ', a.hits'
				. ', a.state, a.ordering, a.language, a.access, a.params, a.created, a.created_by_alias, a.publish_up, a.publish_down'
			)
		);
	...
	public function getCategory()
	{
		if (!is_object($this->_item))
		{
			...
			$categories = JCategories::getInstance('Albums', $options);
