...
class UploadHelper
{
	...
	protected $error_messages = array(
		1                     => 'COM_ALBUMS_ERROR_MESSAGES_1',
		2                     => 'COM_ALBUMS_ERROR_MESSAGES_2',
		3                     => 'COM_ALBUMS_ERROR_MESSAGES_3',
		4                     => 'COM_ALBUMS_ERROR_MESSAGES_4',
		6                     => 'COM_ALBUMS_ERROR_MESSAGES_6',
		7                     => 'COM_ALBUMS_ERROR_MESSAGES_7',
		8                     => 'COM_ALBUMS_ERROR_MESSAGES_8',
		'post_max_size'       => 'COM_ALBUMS_ERROR_MESSAGES_POST_MAX_SIZE',
		'max_file_size'       => 'COM_ALBUMS_ERROR_MESSAGES_MAX_FILE_SIZE',
		'min_file_size'       => 'COM_ALBUMS_ERROR_MESSAGES_MIN_FILE_SIZE',
		'accept_file_types'   => 'COM_ALBUMS_ERROR_MESSAGES_ACCEPT_FILE_TYPES',
		'max_number_of_files' => 'COM_ALBUMS_ERROR_MESSAGES_MAX_NUMBER_OF_FILES',
		'max_width'           => 'COM_ALBUMS_ERROR_MESSAGES_MAX_WIDTH',
		'min_width'           => 'COM_ALBUMS_ERROR_MESSAGES_MIN_WIDTH',
		'max_height'          => 'COM_ALBUMS_ERROR_MESSAGES_MAX_HEIGHT',
		'min_height'          => 'COM_ALBUMS_ERROR_MESSAGES_MIN_HEIGHT'
	);
	 ...
	 * @param   boolean  $initialize  If true, call the initialize.
	 *
	 * @since   3.1
	 */
	...
	/**
	 * Method to get the query separator.
	 *
	...
	/**
	 * Method to set file delete properties.
	 *
	 ...
	 *
	 * @param   stirng   $file_path         The file path.
	 * @param   boolean  $clear_stat_cache  If true, clear stat cache.
	 *
	 * @return  string
	 *
	 * @since   3.1
	...
	/**
	 * Method to verify if is a valid file object.
	 *
	 * @param   string  $file_name  The file name.
	 *
	 * @return  boolean
		...
		if ($this->isValidFileObject($file_name))
		{
			...
			foreach ($this->options['image_versions'] as $version => $options)
			{
				if (!empty($version))
				{
					...
					{
						$file->{$version . '_url'} = $this->getDownloadUrl($file->name, $version);
					}
				}
			}
	...
	/**
	 * Method to get file objects.
	 *
	 * @param   string  $iteration_method  The iteration method.
	 *
	 * @return  array
	 *
	 * @since   3.1
	...
	/**
	 * Method to create scaled image.
	 *
	 * @param   string  $file_name  The file name.
	 * @param   float   $version    The verion.
	...
	/**
	 * Method to up count name call back.
	 *
	 ...
	 *
	 * @param   string   $uploaded_file  The temp file.
	 * @param   string   $name           The file name.
	 * @param   integer  $size           The file size.
	 * @param   string   $type           The file type.
	 * @param   integer  $error          The error, if have.
	 * @param   integer  $index          The index.
	 * @param   integer  $content_range  The content range.
	 *
	 * @return  string
	 *
	 * @since   3.1
	...
	protected function handleFileUpload($uploaded_file, $name, $size, $type, $error, $index = null, $content_range = null)
	{
		...
		if ($file->size)
		{
			// Get an instance of the generic image model.
			$model = JModelLegacy::getInstance('Image', 'AlbumsModel', array('ignore_request' => true));

			// Attempt to save the image.
			$data = array(
				'id'            => 0,
				'album_id'      => $input->getInt('id'),
				'name'          => $file->name,
				'size'          => $file->size,
				'type'          => $file->type,
				'url'           => $file->url,
	...
	public function delete($print_response = true)
	{
		...
		// Get an instance of the image table.
		$image = JTable::getInstance('Image', 'AlbumsTable');
		$image->load(array('album_id' => $input->getInt('id'), 'name' => $file_name));
