...
<form action="<?php echo JRoute::_('index.php?option=com_albums&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="album-form" class="form-validate" enctype="multipart/form-data">
	<div class="row-fluid">
		<!-- Begin Albums -->
		<div class="span10 form-horizontal">
			<fieldset>
				<ul class="nav nav-tabs">
					<li class="active2"><a href="#details" data-toggle="tab"><?php echo empty($this->item->id) ? JText::_('COM_ALBUMS_NEW_ALBUM') : JText::sprintf('COM_ALBUMS_EDIT_ALBUM', $this->item->id); ?></a></li>
					<li class="active"><a href="#images" data-toggle="tab"><?php echo JText::_('COM_ALBUMS_FIELDSET_IMAGES'); ?></a></li>
				...
				<div class="tab-content">
					<div class="tab-pane active2" id="details">
