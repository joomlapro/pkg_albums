			...
			<tr class="template-upload fade">
				...
				{% if (file.error) { %}
					<td class="error" colspan="2">
						<span class="label label-important"><?php echo JText::_('ERROR'); ?></span> {%=file.error%}
					</td>
		...
		(function ($) {
			$(function () {
				...
				$('#album-form').fileupload({
					...
					maxNumberOfFiles: <?php echo $params->get('maxnumberoffiles', 20) ?>,
					minFileSize: <?php echo $params->get('minfilesize', 100) ?>,
					maxFileSize: <?php echo $params->get('maxfilesize', 8000000) ?>,
