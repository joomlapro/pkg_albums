...
class AlbumsViewAlbums extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		// Load the submenu.
		AlbumsHelper::addSubmenu('albums');
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_ALBUMS_MANAGER_ALBUMS'), 'albums.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_albums&view=albums');
